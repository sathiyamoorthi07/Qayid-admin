...
export default function useCustomFont(variant:any) {
	const router = useRouter();

	const [fontName,setFontName] = useState<any>(null);
	...
	useEffect(() => {
		 ...
		 let result = fontsList[langCode][variant]
